    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center rounded-md bg-black/5 pl-3 outline-1 -outline-offset-1 outline-black/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                <input
                                    ...
                                    class="block min-w-0 grow bg-transparent py-1.5 px-3 pl-1 text-base text-black
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div class="flex items-center">
                <button form="delete-form" class="rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-black focus-visible:outline-2
            ...
            <div class="flex items-center gap-x-6">
                ...
                <div>
                    <button type="submit"
                            class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-black focus-visible:outline-2
